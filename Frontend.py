	...
	def __init__(self, root):
		...
		def adddata():
			if(len(Movie_ID.get())!=0):
				Backend.AddMovieRec(Movie_ID.get(),Movie_Name.get(),Release_Date.get(),Director.get(),Cast.get(),Budget.get(),Duration.get(),Rating.get())
		...
		def deldata():
			if(len(Movie_ID.get())!=0):
				Backend.DeleteMovieRec(sd[0])
				clcdata()
				disdata()

		def searchdb():
			MovieList.delete(0,END)
			for row in Backend.SearchMovieData(Movie_ID.get(),Movie_Name.get(),Release_Date.get(),Director.get(),Cast.get(),Budget.get(),Duration.get(),Rating.get()):
				MovieList.insert(END, row, str(""))
		...
		self.lblMovie_ID=Label(DFrameL, font=('Arial', 18, 'bold'), text="Show Time:", padx=2, pady=2, bg="black", fg="orange")
		...
		self.lblRelease_Date=Label(DFrameL, font=('Arial', 18, 'bold'), text="Date:", padx=2, pady=2, bg="black", fg="orange")
		...
		self.lblDirector=Label(DFrameL, font=('Arial', 18, 'bold'), text="No of Tickets:", padx=2, pady=2, bg="black", fg="orange")
		...
		self.lblCast=Label(DFrameL, font=('Arial', 18, 'bold'), text="City:", padx=2, pady=2, bg="black", fg="orange")
		...
		self.lblBudget=Label(DFrameL, font=('Arial', 18, 'bold'), text="Theatre:", padx=2, pady=2, bg="black", fg="orange")
		...
		self.lblDuration=Label(DFrameL, font=('Arial', 18, 'bold'), text="Preview Type:", padx=2, pady=2, bg="black", fg="orange")
		...
		self.lblRating=Label(DFrameL, font=('Arial', 18, 'bold'), text="Meals (Y/N):", padx=2, pady=2, bg="black", fg="orange")
